...
class simpleapp_tk(Tkinter.Tk):
    ...
    def initialize(self):
        ...
        for item in companyData:
            ...
            self.labelVariable.set('  {:<5}\t{:>7}\t{:>6}\t{:>8}\t\t{:>6}\t{:>6}\t{:>6}\t{:>6}\t{:>16}\t{:>16}'.format(item, companyData[item]['last'], str(companyData[item]['change']), str(companyData[item]['pctChange']), str(companyData[item]['ret1']), str(companyData[item]['ret7']), str(companyData[item]['ret30']), str(companyData[item]['ret90']), str(companyData[item]['vol']), str(companyData[item]['volAvg'])))
